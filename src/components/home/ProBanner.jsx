...
const ProBanner = () => {
    ...
    return (
        <section className="max-w-[1400px] mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6">
            <div className="brand-gradient rounded-xl sm:rounded-3xl p-5 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-5 sm:gap-6 shadow-xl">
                ...
                <div className="flex flex-col gap-4 flex-1">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-amber-50 text-sm">Para profesionales</span>
                    </div>

                    <h2 className="text-xl sm:text-3xl font-bold text-white">
                        ¿Eres Maestro o tienes una PYME?
                    </h2>
                    <p className="text-amber-50 text-sm max-w-lg">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 mt-2">
                        ...
                        <div className="flex items-center gap-2 text-white">
                            <CreditCard size={16} className="text-amber-300 shrink-0" />
                            <span className="text-sm">FerreCredito a cuotas</span>
                        </div>
                        <div className="flex items-center gap-2 text-white">
                            <Briefcase size={16} className="text-amber-300 shrink-0" />
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 mt-2">
                        <button
                            ...
                            className="flex items-center justify-center gap-2 brand-button px-6 py-3 rounded-xl font-semibold transition"
                        >
                            <Hammer size={18} />
                            Soy Maestro
