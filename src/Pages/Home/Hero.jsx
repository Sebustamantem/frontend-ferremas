  ...
  return (
    <section className="w-full">
      <div className="w-full sm:max-w-[1450px] sm:mx-auto sm:px-6 lg:px-8 xl:px-10 pt-0 md:pt-4">
        ...
        <div className="w-full h-[180px] sm:h-[240px] md:h-[320px] lg:h-[400px] xl:h-[450px] rounded-none sm:rounded-3xl shadow-2xl bg-gray-900 flex items-center justify-center text-white text-center px-4 sm:px-6">
